        ...
        <footer className="w-full mt-auto py-4 md:py-8 border-t border-[var(--card-border)] bg-[var(--card)]/20 backdrop-blur-sm animate-fade-in">
            <div className="w-full max-w-[1400px] mx-auto px-4 md:px-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-6">
                <div className="flex items-center gap-3 md:gap-4">
                    ...
                    >
                        <img src="/bandhannova-logo-final.svg" alt="BandhanNova Logo" className="h-5 md:h-6 w-auto" />
                    </a>
                    <div className="h-3 w-[1px] bg-[var(--card-border)] hidden md:block" />
                    <div className="flex flex-col items-start">
                        <span className="text-[10px] md:text-xs font-dynapuff font-extrabold tracking-[0.2em] text-indigo-500 uppercase select-none">
                            Smartpedia
                        </span>
                    </div>
                </div>
